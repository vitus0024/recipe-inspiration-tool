 ...
 *   - whole    ：（選填）只能整數計量的食材（雞蛋、雞翅、吐司…）——換算人份時無條件捨去成整數、最少 1，
 *                不會出現 1.5 顆蛋；沒標的按 0.5 為單位（半顆洋蔥、半條蘿蔔是合理的）
 *
...
const INGREDIENT_CATALOG = [
  ...
  { name: "蔥", category: "葉菜", aliases: ["青蔥", "蔥花"], whole: true },
  { name: "大白菜", category: "葉菜", aliases: ["白菜", "結球白菜", "包心白菜"] },
  { name: "芹菜", category: "葉菜", aliases: ["台芹", "西芹", "西洋芹"], whole: true },
  ...
  { name: "秋葵", category: "瓜果根莖", aliases: ["黃秋葵", "羊角豆"], whole: true },
  ...
  { name: "玉米筍", category: "瓜果根莖", aliases: ["小玉米", "珍珠筍"], whole: true },
  ...
  // ── 菇類 ──────────────────────────────
  { name: "香菇", category: "菇類", aliases: ["鮮香菇", "生香菇"], whole: true },
  { name: "乾香菇", category: "菇類", aliases: ["香菇乾"], whole: true },
  { name: "杏鮑菇", category: "菇類", aliases: ["杏鮑菇片"] },
  { name: "黑木耳", category: "菇類", aliases: ["木耳"], whole: true },
  ...
  { name: "豬里肌", category: "肉類", aliases: ["豬里肌肉", "豬里肌片", "里肌肉", "里肌"], whole: true },
  ...
  { name: "雞翅", category: "肉類", aliases: ["二節翅", "三節翅", "翅小腿", "雞翅膀"], whole: true },
  { name: "牛絞肉", category: "肉類", aliases: ["牛肉末", "牛絞肉末"] },
  { name: "培根", category: "肉類", aliases: [], whole: true },
  { name: "香腸", category: "肉類", aliases: ["台式香腸", "臘腸"], whole: true },

  // ── 海鮮 ──────────────────────────────
  { name: "蝦仁", category: "海鮮", aliases: ["白蝦仁", "白蝦", "蝦"] },
  { name: "鮭魚", category: "海鮮", aliases: ["鮭魚片", "鮭魚排"], whole: true },
  { name: "魚片", category: "海鮮", aliases: ["鱸魚片", "鯛魚片", "白身魚片", "鯛魚"], whole: true },
  ...
  { name: "鯖魚", category: "海鮮", aliases: ["鹽漬鯖魚", "薄鹽鯖魚", "青花魚"], whole: true },
  { name: "鱈魚", category: "海鮮", aliases: ["鱈魚片", "扁鱈", "圓鱈"], whole: true },

  // ── 蛋豆製品 ──────────────────────────────
  { name: "雞蛋", category: "蛋豆製品", aliases: ["蛋", "土雞蛋"], whole: true },
  { name: "皮蛋", category: "蛋豆製品", aliases: ["松花蛋"], whole: true },
  { name: "嫩豆腐", category: "蛋豆製品", aliases: ["小豆腐", "嫩豆花", "盒裝豆腐", "涼拌豆腐"] },
  { name: "板豆腐", category: "蛋豆製品", aliases: ["老豆腐", "傳統豆腐"] },
  { name: "豆干", category: "蛋豆製品", aliases: ["豆乾", "豆腐乾", "五香豆干"], whole: true },
  { name: "油豆腐", category: "蛋豆製品", aliases: ["豆泡", "油豆泡", "三角油豆腐"], whole: true },
  { name: "豆皮", category: "蛋豆製品", aliases: ["生豆皮", "豆包", "腐皮"], whole: true },
  ...
  { name: "烏龍麵", category: "主食", aliases: ["烏冬", "讚岐烏龍麵"], whole: true },
  { name: "年糕", category: "主食", aliases: ["韓式年糕", "寧波年糕", "條狀年糕"] },
  { name: "吐司", category: "主食", aliases: ["土司", "白吐司", "麵包"], whole: true }
];
